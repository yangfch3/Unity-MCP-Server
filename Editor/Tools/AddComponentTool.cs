...
namespace UnityMcp.Editor.Tools
{
    ...
    public class AddComponentTool : IMcpTool
    {
        ...
        /// <inheritdoc />
        public string InputSchema => "{\"type\":\"object\",\"properties\":{\"instanceID\":{\"type\":\"integer\",\"description\":\"目标 GameObject 的 instanceID（instanceID/path 二选一，同传则 ID 优先）\"},\"path\":{\"type\":\"string\",\"description\":\"目标 GameObject 的路径（如 \\\"/Root/Child\\\"）\"},\"componentType\":{\"type\":\"string\",\"description\":\"要添加的组件类型名（如 \\\"BoxCollider\\\"）\"}},\"required\":[\"componentType\"]}";
