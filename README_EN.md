...
| `debug_screenshot` | Capture Game/Scene view screenshot (base64 image, occlusion-proof; game requires Play mode; disabled by default, enable it in the panel's Experimental section) |
